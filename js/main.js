...
app.controller('index', function($scope ,$rootScope ,$http ,$location ,$window) {
    ...
    $scope.loadconfig = function(url){
      ...
      $http({
         method: 'POST',
         url: "http://flaskapp.io-media.com:5000/getConfig",
         data: { "url" : url },
    ...
    $scope.login = function(input) {
      ...
      if ($scope.login_button == "LogOut") {
         $http({
           method: 'GET',
           url: "http://flaskapp.io-media.com:5000/logout",
           }).then(function(result) {
      ...
      $http({
       method: 'POST',
       url: "http://flaskapp.io-media.com:5000/drupal/login",
       ...
       $http({
         method: 'POST',
         url: "http://flaskapp.io-media.com:5000/saveConfig",
      ...
      $http({
         method: 'POST',
         url: "http://flaskapp.io-media.com:5000/tm/login",
